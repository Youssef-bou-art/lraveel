...
<head>
  ...
  <title>Admin Dashboard - Digi_Learn</title>
  <style>
    * {
...
<p>Utilisateurs inscrits</p>
    ...
    <div class="card">
      <h2>{{ \App\Models\Course1::count() + \App\Models\Course2::count() }}</h2>
<p>Cours disponibles</p>

    </div>
    <div class="card">
 <h2>{{ \App\Models\efm1::count() + \App\Models\efm2::count() }}</h2>
      <p>EFMs ajoutés</p>
    </div>
    
    <!-- 1ère Année and 2ème Année cards in same row -->
    <div class="card">
      <h2>1ère Année</h2>
      <p>Gérer les cours et les EFMs</p>
      <a href="{{ route('ce.page') }}" class="manage-btn">Gérer</a>
    </div>
    <div class="card">
      <h2>2ème Année</h2>
      <p>Gérer les cours et les EFMs</p>
      <a href="{{ route('ce2.page') }}" class="manage-btn">Gérer</a>
    </div>
  </div>
